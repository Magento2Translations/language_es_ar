...
The Spanish (español) translations used can be found [here](https://crowdin.com/project/magento-2/es).
...
* Upload the contents to `<your magento path>/app/i18n/magento2translations/es_AR`.
